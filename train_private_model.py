...
def main():
    ...
    parser.add_argument('--weights_file', type=str, default='vgg16_cifar100_x224_std_5.0_eps_0.1_delta_1e-5.pth', help='')
    ...
    parser.add_argument('--batch_size', type=int, default=116, help='')
